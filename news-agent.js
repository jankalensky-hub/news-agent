...
// Získání českých zpráv z NewsAPI
...
function generateImportanceReason(article, position) {
    ...
    const categories = {
        politics: ['vláda', 'politik', 'premiér', 'parlament', 'volby', 'zákon', 'minister'],
        economy: ['ekonomika', 'inflace', 'koruna', 'banka', 'investice', 'trh', 'firmy', 'hmotný'],
        health: ['zdraví', 'nemocnice', 'léky', 'covid', 'zdravotnictví', 'pacient'],
        technology: ['technologie', 'internet', 'aplikace', 'digitál', 'ai', 'počítač'],
        security: ['bezpečnost', 'policie', 'nehoda', 'požár', 'krize', 'útok'],
        international: ['svět', 'europa', 'usa', 'rusko', 'ukrajina', 'mezinárodní']
    };
    ...
    const reasons = {
        politics: `Politické rozhodnutí s přímým dopadem na občany. ${position}. nejčtenější zpráva dne.`,
        economy: `Ekonomická zpráva ovlivňující finanční situaci domácností. Důležitá pro plánování rozpočtu.`,
        health: `Zdravotní téma s významem pro veřejné zdraví. Může ovlivnit dostupnost péče.`,
        technology: `Technologický vývoj měnící způsob života a práce. Trend s dlouhodobým dopadem.`,
        security: `Bezpečnostní událost s dopadem na veřejný pořádek. Informace pro občany.`,
